...
public class RestServices  extends Application{
	...
	//http://localhost:8080/MarousiGeocoderServer/geo/RestService/getaddress?address=Κηφισίας
	@GET
	@Path("/getaddress")
	...
	//http://localhost:8080/MarousiGeocoderServer/geo/RestService/postaddress?address=Κηφισίας
	@POST
