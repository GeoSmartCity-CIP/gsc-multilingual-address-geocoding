...
public class RestServices  extends Application{
	...
	//http://localhost:8080/MarousiGeocoderServer/geo/RestService/sayHello
	@GET
	@Path("/sayHello")
	...
	//http://localhost:8080/TurkuGeocoderServer/geo/RestService/getaddress?address=Helsingin%20valtatie‚
	@GET
	@Path("/getaddress")
	...
	//http://localhost:8080/TurkuGeocoderServer/geo/RestService/postaddress?address=Helsingin%20valtatie‚
	@POST
	...
	//http://localhost:8080/TurkuGeocoderServer/geo/RestService/getcoordinates?lng=2.83386&lat=42.00351&srs=4326
	@GET
	@Path("/getcoordinates")
	@Produces(MediaType.APPLICATION_JSON  + ";charset=utf-8")
	...
	//http://localhost:8080/TurkuGeocoderServer/geo/RestService/postaddress?lng=2.83386&lat=42.00351&srs=4326‚
	@POST
